...
kpath = get_bandpath([G, M, K, G, A, L, H, A], ase_cell.cell, npoints=50)
band_kpts = kpath.kpts
kpath, band_kpts, sp_points = kpath.get_linear_kpoint_axis()
