...
for bond_distance in np.arange(0.5, 6.0, 0.25):
    ...
    # now do drpa
    g0w0_drpa_dm = lin_gw_dm(my_drpa, mf)
    # assert that this density matrix is hermitian
    ...
    for key, dm in zip(['hf', 'fci', 'drpa'], [hf_dm, fci_dm, diag_drpa]):
...
legend_elements = [
    Line2D([0], [0], color='b', lw=4, label='HOMO'),
    Line2D([0], [0], color='r', lw=4, label='LUMO'),
    Line2D([0], [0], marker='*', color='w', label='Hartree-Fock', markerfacecolor='k', markeredgecolor='k', markersize=10),
    Line2D([0], [0], marker='+', color='w', label='Exact (Full CI)', markerfacecolor='k', markeredgecolor='k', markersize=10),
    # Line2D([0], [0], marker='x', color='w', label='dTDA', markerfacecolor='k', markeredgecolor='k', markersize=10),
    Line2D([0], [0], marker='^', color='w', label=rf'$\gamma^{{GW}}$', markerfacecolor='k', markeredgecolor='k', markersize=10),
]
